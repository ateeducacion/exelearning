 ...
 *
 * Covers two areas:
 *  - importGlosary() HTML-tag stripping must be complete sanitization. A
 *    single-pass strip like .replace(/<[^>]*>/g, '') can be defeated because
 ...
 *  - TikZ rendering/sanitization, SVG capture and the embedded font parser.
 */
