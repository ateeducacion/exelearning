...
commit them) compiled by the centralized build. Slide and the 360° Viewer
follow this model today. The decision record is
[ADR-2147-01](../architecture/adr/ADR-2147-01-typescript-idevices-build-convention.md).
...
- Add **bundle-contract smoke tests** that evaluate the ACTUAL compiled IIFEs
  ...
  `three-sixty-viewer/src/test/bundle-contract.spec.ts`).
