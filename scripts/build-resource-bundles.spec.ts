...
describe('build-resource-bundles', () => {
    ...
    describe('staticFiles (loose-file mappings for static mode)', () => {
        ...
        it('should not list .map files in idevice/common staticFiles or idevices.zip', () => {
            // Source maps next to generated TypeScript iDevice bundles (e.g. the
            // 3D Viewer) are a development aid; scanDirectory must drop them so
            // they never ship in resource ZIPs or the static loose-file manifest.
